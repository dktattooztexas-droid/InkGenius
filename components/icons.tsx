...
export const TattooMachineIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.843 15.313A3.75 3.75 0 0 1 5.25 15.75c-1.423 0-2.66-.7-3.375-1.719a3.753 3.753 0 0 1-.95-2.063 3.75 3.75 0 0 1 .95-2.063c.715-1.019 1.952-1.719 3.375-1.719 1.136 0 2.14.412 2.872 1.063m2.038 2.812a3.75 3.75 0 0 1 0-5.625m2.038 5.625a3.75 3.75 0 0 0 0-5.625m2.038 5.625c.732-.65 1.736-1.063 2.872-1.063 1.423 0 2.66.7 3.375 1.719a3.75 3.75 0 0 1 .95 2.063 3.75 3.75 0 0 1-.95 2.063c-.715 1.019-1.952 1.719-3.375-1.719-1.136 0-2.14-.412-2.872-1.063M12 9.75v1.5m0 3v1.5m0-6v1.5m-3.375 0h.75m6 0h.75M12 18a2.25 2.25 0 0 0 2.25-2.25H9.75A2.25 2.25 0 0 0 12 18Zm0-15.75a2.25 2.25 0 0 0-2.25 2.25h4.5A2.25 2.25 0 0 0 12 2.25Z" />
    </svg>
);
...
export const GalleryIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 014.5 4.875h15A2.25 2.25 0 0121.75 7.125v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25v-10.5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 12.031l3.75-3.75a.75.75 0 011.06 0l3.75 3.75-3.75 3.75a.75.75 0 01-1.06 0l-3.75-3.75z" />
    </svg>
);
...
export const ArtPlaceholderIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
